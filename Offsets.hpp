...
constexpr long OFF_NAMELIST = 0xd3cabd0;    //[Miscellaneous]->NameList
...
constexpr long OFF_VIEW_RENDER = 0x76ddcd8;  //[RecvTable.DT_Player]->ViewRender
...
constexpr long OFF_GLOW_HIGHLIGHTS = 0xb17ee20;
